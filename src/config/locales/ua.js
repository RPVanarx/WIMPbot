module.exports = {
  WELCOME_MESSAGE: `Привіт, Ви приєдналися до чат-боту з пошуку загублених домашніх улюбленців. Весь функціонал буде доступний після реєстрації.`,
  ...
  REGISTRATION_BUTTONS: {
    ...
    DEACTIVATE_USER: 'Не хочу отримувати заявки',
    ACTIVATE_USER: 'Хочу знову отримувати заявки',
  },

  REGISTRATION_MESSAGES: {
    CREATE:
      'Включіть GPS на Вашому телефоні та відправте свої координати, використовуючи функцію Location',
  ...
  DEACTIVATE_USER: {
    QUESTION: 'Ви впевнені що не бажаєте більше отримувати заявки?',
    TRUE: 'Ваш запит на відписку від заявок прийнято',
    FALSE: 'Відміна',
  },

  ACTIVATE_USER: {
    QUESTION: 'Ви впевнені що бажаєте знову отримувати заявки?',
    TRUE: 'Ваш запит на отримання заявок прийнято',
    FALSE: 'Відміна',
  },
  ...
  UPDATE_LOCATION_MESSAGES: {
    ...
    ERROR: 'Локація була введена невірно',
  },
  ...
  CREATE_REQUEST_MESSAGES: {
    ...
    NO_USER_NAME:
      'Для того щоб відправити заявку, у вашому телеграм-профілі має бути вказаний username. Створіть власний username та спробуйте створити заявку знову',
  ...
  FIND_REQUESTS_MESSAGES: {
    ...
    DAYS:
      'На скільки старі заявки ви бажаєте отримати? Напишіть одне значення кількості днів від 1 до 30',
  ...
  SERVICES_MESSAGES: {
    ...
    MODERATION_TRUE:
      'Ваша заявка пройшла модерацію і була опублінована в системі. Після того як улюбленця буде знайдено, прохання закрити цю заявку та по можливості написати відгук на facebook сторінці https://www.facebook.com/WIMPbot/ . Для нас важливо знати, що бот допоміг знайти Вашого улюбленця!',
  },
